...
function [inputs] = singleInput(cname,dNNz1,dNNz2)
	...
	N = 10;
	for i=1:N
		input.PatchDiam1 = round(prctile(dNNz1,100),3) * 1.01 * 2.0;
		input.PatchDiam2Min = round(prctile(dNNz2,0),3) * 1.01 * 2.0;
		input.PatchDiam2Max = round(prctile(dNNz2,100),3) * 1.01 * 2.0;
		input.lcyl = lcyl;
		input.FilRad = filrad;
